...
// ===== START SAKURA PETALS FOR EMOTIONAL MOMENTS =====
let sakuraInterval;
...
function enableGalleryKeyboard() {
  if (galleryKeyboardActive) return;
  galleryKeyboardActive = true;
  
  document.addEventListener('keydown', handleGalleryKeyboard);
}

function disableGalleryKeyboard() {
...
const animationTimeline = () => {
  ...
  tl.to(".container", 0.6, {
    ...
    // Stay on philosophy section for 10 seconds total, then fade out music
    .to(".nine", 0.5, {
      opacity: 0,
      visibility: "hidden",
    ...
    .to(".birthday-wishes-section", 0.1, {
      visibility: "visible",
    })
    .to(".birthday-wishes-section", 1, {
      opacity: 1,
      ease: Power2.easeOut,
    })
    .from(".wishes-container", 1.2, {
      scale: 0.8,
      y: 50,
      opacity: 0,
    ...
    .staggerTo(".wishes-text", 0.8, {
      opacity: 1,
      y: 0,
      ease: Power2.easeOut,
    }, 0.3)
    // Wait 8 seconds, fade out wishes, fade in music
    .to(".birthday-wishes-section", 0.5, {
      opacity: 0,
      visibility: "hidden",
      onStart: fadeInMusic,
    }, "+=8")
    ...
    // Show replay button after 30 seconds
    .to(".letter-replay-btn", 0.5, {
      opacity: 1,
      visibility: "visible",
      y: 0,
      ease: Back.easeOut.config(1.7),
